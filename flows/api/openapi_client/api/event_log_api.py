...
class EventLogApi:
    ...
    def get_event_log(
        ...
        :param event_log_id: The event log ID. (required)
    ...
    def _get_event_log_serialize(
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/eventLogs/{event_log_id}',
    ...
    def get_event_logs(
        ...
        dag_id: Annotated[Optional[StrictStr], Field(description="Returns objects matched by the DAG ID.")] = None,
        task_id: Annotated[Optional[StrictStr], Field(description="Returns objects matched by the Task ID.")] = None,
        run_id: Annotated[Optional[StrictStr], Field(description="Returns objects matched by the Run ID.")] = None,
        map_index: Annotated[Optional[StrictInt], Field(description="Filter on map index for mapped task.")] = None,
        try_number: Annotated[Optional[StrictInt], Field(description="Filter on try_number for task instance.")] = None,
        event: Annotated[Optional[StrictStr], Field(description="The name of event log.")] = None,
        owner: Annotated[Optional[StrictStr], Field(description="The owner's name of event log.")] = None,
        before: Annotated[Optional[datetime], Field(description="Timestamp to select event logs occurring before.")] = None,
        after: Annotated[Optional[datetime], Field(description="Timestamp to select event logs occurring after.")] = None,
        included_events: Annotated[Optional[StrictStr], Field(description="One or more event names separated by commas. If set, only return event logs with events matching this pattern. *New in version 2.9.0* ")] = None,
        excluded_events: Annotated[Optional[StrictStr], Field(description="One or more event names separated by commas. If set, only return event logs with events that do not match this pattern. *New in version 2.9.0* ")] = None,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
            Tuple[
        ...
        :type order_by: str
        :param dag_id: Returns objects matched by the DAG ID.
        :type dag_id: str
        :param task_id: Returns objects matched by the Task ID.
        :type task_id: str
        :param run_id: Returns objects matched by the Run ID.
        :type run_id: str
        :param map_index: Filter on map index for mapped task.
        :type map_index: int
        :param try_number: Filter on try_number for task instance.
        :type try_number: int
        :param event: The name of event log.
        :type event: str
        :param owner: The owner's name of event log.
        :type owner: str
        :param before: Timestamp to select event logs occurring before.
        :type before: datetime
        :param after: Timestamp to select event logs occurring after.
        :type after: datetime
        :param included_events: One or more event names separated by commas. If set, only return event logs with events matching this pattern. *New in version 2.9.0* 
        :type included_events: str
        :param excluded_events: One or more event names separated by commas. If set, only return event logs with events that do not match this pattern. *New in version 2.9.0* 
        :type excluded_events: str
        :param _request_timeout: timeout setting for this request. If one
                                 number provided, it will be total request
                                 timeout. It can also be a pair (tuple) of
                                 (connection, read) timeouts.
