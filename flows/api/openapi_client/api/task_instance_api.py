...
from openapi_client.models.task_instance_dependency_collection import TaskInstanceDependencyCollection
from openapi_client.models.task_instance_history import TaskInstanceHistory
from openapi_client.models.task_instance_history_collection import TaskInstanceHistoryCollection
...
class TaskInstanceApi:
    ...
    def get_mapped_task_instance_dependencies(
        ...
        _param = self._get_mapped_task_instance_dependencies_serialize(
            dag_id=dag_id,
            dag_run_id=dag_run_id,
            task_id=task_id,
            map_index=map_index,
    ...
    @validate_call
    def get_mapped_task_instance_dependencies_with_http_info(
        self,
        dag_id: Annotated[StrictStr, Field(description="The DAG ID.")],
        dag_run_id: Annotated[StrictStr, Field(description="The DAG run ID.")],
        task_id: Annotated[StrictStr, Field(description="The task ID.")],
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[TaskInstanceDependencyCollection]:
        """Get task dependencies blocking task from getting scheduled.
    ...
    @validate_call
    def get_mapped_task_instance_dependencies_without_preload_content(
        self,
        dag_id: Annotated[StrictStr, Field(description="The DAG ID.")],
        dag_run_id: Annotated[StrictStr, Field(description="The DAG run ID.")],
        task_id: Annotated[StrictStr, Field(description="The task ID.")],
    ...
    def _get_mapped_task_instance_dependencies_serialize(
        self,
        dag_id,
        dag_run_id,
        task_id,
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/dags/{dag_id}/dagRuns/{dag_run_id}/taskInstances/{task_id}/{map_index}/dependencies',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    def get_mapped_task_instance_tries(
        ...
        _response_types_map: Dict[str, Optional[str]] = {
            '200': "TaskInstanceHistoryCollection",
            '401': "Error",
            '403': "Error",
            '404': "Error",
        }
    ...
    def get_mapped_task_instance_tries_with_http_info(
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[TaskInstanceHistoryCollection]:
        """List mapped task instance tries
    ...
    def _get_mapped_task_instance_tries_serialize(
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/dags/{dag_id}/dagRuns/{dag_run_id}/taskInstances/{task_id}/{map_index}/tries',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    def get_mapped_task_instance_try_details_with_http_info(
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[TaskInstanceHistory]:
        """get mapped taskinstance try
    ...
    def _get_mapped_task_instance_try_details_serialize(
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/dags/{dag_id}/dagRuns/{dag_run_id}/taskInstances/{task_id}/{map_index}/tries/{task_try_number}',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    def get_mapped_task_instances(
        ...
        updated_at_gte: Annotated[Optional[datetime], Field(description="Returns objects greater or equal the specified date.  This can be combined with updated_at_lte parameter to receive only the selected period.  *New in version 2.6.0* ")] = None,
        updated_at_lte: Annotated[Optional[datetime], Field(description="Returns objects less or equal the specified date.  This can be combined with updated_at_gte parameter to receive only the selected period.  *New in version 2.6.0* ")] = None,
        ...
        executor: Annotated[Optional[List[StrictStr]], Field(description="The value can be repeated to retrieve multiple matching values (OR condition).")] = None,
        order_by: Annotated[Optional[StrictStr], Field(description="The name of the field to order the results by. Prefix a field name with `-` to reverse the sort order.  *New in version 2.1.0* ")] = None,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
        ...
        :param updated_at_gte: Returns objects greater or equal the specified date.  This can be combined with updated_at_lte parameter to receive only the selected period.  *New in version 2.6.0* 
        :type updated_at_gte: datetime
        :param updated_at_lte: Returns objects less or equal the specified date.  This can be combined with updated_at_gte parameter to receive only the selected period.  *New in version 2.6.0* 
        ...
        :type queue: List[str]
        :param executor: The value can be repeated to retrieve multiple matching values (OR condition).
    ...
    def _get_task_instance_dependencies_serialize(
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/dags/{dag_id}/dagRuns/{dag_run_id}/taskInstances/{task_id}/dependencies',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    def _get_task_instance_tries_serialize(
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/dags/{dag_id}/dagRuns/{dag_run_id}/taskInstances/{task_id}/tries',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    def _get_task_instance_try_details_serialize(
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/dags/{dag_id}/dagRuns/{dag_run_id}/taskInstances/{task_id}/tries/{task_try_number}',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
