...
class DagStatsApi:
    ...
    def get_dag_stats(
        self,
        dag_ids: Annotated[StrictStr, Field(description="One or more DAG IDs separated by commas to filter relevant Dags. ")],
        ...
        :param dag_ids: One or more DAG IDs separated by commas to filter relevant Dags.  (required)
        :type dag_ids: str
    ...
    def get_dag_stats_with_http_info(
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[DagStatsCollectionSchema]:
        """List Dag statistics
