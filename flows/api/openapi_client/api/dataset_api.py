...
from typing_extensions import Annotated
from openapi_client.models.create_dataset_event import CreateDatasetEvent
...
from openapi_client.models.queued_event import QueuedEvent
from openapi_client.models.queued_event_collection import QueuedEventCollection
...
class DatasetApi:
    ...
    def delete_dag_dataset_queued_event(
        ...
        _param = self._delete_dag_dataset_queued_event_serialize(
            dag_id=dag_id,
            uri=uri,
            before=before,
            _request_auth=_request_auth,
    ...
    def _delete_dag_dataset_queued_event_serialize(
        self,
        dag_id,
        uri,
        before,
        ...
        return self.api_client.param_serialize(
            method='DELETE',
            resource_path='/dags/{dag_id}/datasets/queuedEvent/{uri}',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    def delete_dag_dataset_queued_events(
        ...
        _param = self._delete_dag_dataset_queued_events_serialize(
            dag_id=dag_id,
            before=before,
            _request_auth=_request_auth,
            _content_type=_content_type,
    ...
    def _delete_dag_dataset_queued_events_serialize(
        self,
        dag_id,
        before,
        _request_auth,
        ...
        return self.api_client.param_serialize(
            method='DELETE',
            resource_path='/dags/{dag_id}/datasets/queuedEvent',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    def delete_dataset_queued_events(
        ...
        _param = self._delete_dataset_queued_events_serialize(
            uri=uri,
            before=before,
            _request_auth=_request_auth,
            _content_type=_content_type,
    ...
    def _delete_dataset_queued_events_serialize(
        self,
        uri,
        before,
        _request_auth,
        ...
        return self.api_client.param_serialize(
            method='DELETE',
            resource_path='/datasets/queuedEvent/{uri}',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    def get_dag_dataset_queued_event(
        ...
        _param = self._get_dag_dataset_queued_event_serialize(
            dag_id=dag_id,
            uri=uri,
            before=before,
            _request_auth=_request_auth,
    ...
    def _get_dag_dataset_queued_event_serialize(
        self,
        dag_id,
        uri,
        before,
    ...
    def get_dag_dataset_queued_events(
        ...
        _param = self._get_dag_dataset_queued_events_serialize(
            dag_id=dag_id,
            before=before,
            _request_auth=_request_auth,
            _content_type=_content_type,
    ...
    def _get_dag_dataset_queued_events_serialize(
        self,
        dag_id,
        before,
        _request_auth,
    ...
    def get_dataset_queued_events(
        ...
        _param = self._get_dataset_queued_events_serialize(
            uri=uri,
            before=before,
            _request_auth=_request_auth,
            _content_type=_content_type,
    ...
    def _get_dataset_queued_events_serialize(
        self,
        uri,
        before,
        _request_auth,
    ...
    def get_datasets(
        ...
        dag_ids: Annotated[Optional[StrictStr], Field(description="One or more DAG IDs separated by commas to filter datasets by associated DAGs either consuming or producing.  *New in version 2.9.0* ")] = None,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
            Tuple[
        ...
        :param dag_ids: One or more DAG IDs separated by commas to filter datasets by associated DAGs either consuming or producing.  *New in version 2.9.0* 
        :type dag_ids: str
        :param _request_timeout: timeout setting for this request. If one
                                 number provided, it will be total request
                                 timeout. It can also be a pair (tuple) of
