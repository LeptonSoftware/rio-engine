...
class ConfigApi:
    ...
    def get_config(
        ...
        :param section: If given, only return config of this section.
        :type section: str
    ...
    def get_value(
        ...
        _param = self._get_value_serialize(
            section=section,
            option=option,
            _request_auth=_request_auth,
            _content_type=_content_type,
    ...
    def _get_value_serialize(
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/config/section/{section}/option/{option}',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
