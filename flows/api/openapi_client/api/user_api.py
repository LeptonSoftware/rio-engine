...
class UserApi:
    ...
    def delete_user(
        ...
        """ # noqa: E501
        warnings.warn("DELETE /users/{username} is deprecated.", DeprecationWarning)
    ...
    def get_user(
        ...
        :return: Returns the result object.
        """ # noqa: E501
        warnings.warn("GET /users/{username} is deprecated.", DeprecationWarning)
    ...
    def patch_user(
        ...
        :return: Returns the result object.
        """ # noqa: E501
        warnings.warn("PATCH /users/{username} is deprecated.", DeprecationWarning)
