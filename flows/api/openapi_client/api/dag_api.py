...
class DAGApi:
    ...
    def get_dag(
        ...
        :param dag_id: The DAG ID. (required)
        :type dag_id: str
        :param fields: List of field for return. 
    ...
    def _get_dag_details_serialize(
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/dags/{dag_id}/details',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    def get_dag_source(
        ...
        :param file_token: The key containing the encrypted path to the file. Encryption and decryption take place only on the server. This prevents the client from reading an non-DAG file. This also ensures API extensibility, because the format of encrypted data may change.  (required)
        :type file_token: str
        :param _request_timeout: timeout setting for this request. If one
                                 number provided, it will be total request
                                 timeout. It can also be a pair (tuple) of
    ...
    def _get_dag_source_serialize(
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/dagSources/{file_token}',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    def get_dags(
        ...
        only_active: Annotated[Optional[StrictBool], Field(description="Only filter active DAGs.  *New in version 2.1.1* ")] = None,
        paused: Annotated[Optional[StrictBool], Field(description="Only filter paused/unpaused DAGs. If absent or null, it returns paused and unpaused DAGs.  *New in version 2.6.0* ")] = None,
        fields: Annotated[Optional[List[StrictStr]], Field(description="List of field for return. ")] = None,
        dag_id_pattern: Annotated[Optional[StrictStr], Field(description="If set, only return DAGs with dag_ids matching this pattern. ")] = None,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
            Tuple[
        ...
        :param paused: Only filter paused/unpaused DAGs. If absent or null, it returns paused and unpaused DAGs.  *New in version 2.6.0* 
        :type paused: bool
        :param fields: List of field for return. 
        :type fields: List[str]
    ...
    def _get_task_serialize(
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/dags/{dag_id}/tasks/{task_id}',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    def _get_tasks_serialize(
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/dags/{dag_id}/tasks',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    def _post_clear_task_instances_serialize(
        ...
        return self.api_client.param_serialize(
            method='POST',
            resource_path='/dags/{dag_id}/clearTaskInstances',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    def _post_set_task_instances_state_serialize(
        ...
        return self.api_client.param_serialize(
            method='POST',
            resource_path='/dags/{dag_id}/updateTaskInstancesState',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    def _reparse_dag_file_serialize(
        ...
        return self.api_client.param_serialize(
            method='PUT',
            resource_path='/parseDagFile/{file_token}',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
