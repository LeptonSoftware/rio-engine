...
class DAGDetail(BaseModel):
    ...
    dag_display_name: Optional[StrictStr] = Field(default=None, description="Human centric display text for the DAG.  *New in version 2.9.0* ")
    ...
    default_view: Optional[StrictStr] = None
    ...
    max_consecutive_failed_dag_runs: Optional[StrictInt] = Field(default=None, description="(experimental) The maximum number of consecutive DAG failures before DAG is automatically paused.  *New in version 2.9.0* ")
    ...
    start_date: Optional[datetime] = Field(default=None, description="The DAG's start date.  *Changed in version 2.0.1*&#58; Field becomes nullable. ")
    dag_run_timeout: Optional[TimeDelta] = None
    dataset_expression: Optional[Dict[str, Any]] = Field(default=None, description="Nested dataset any/all conditions")
    doc_md: Optional[StrictStr] = None
    params: Optional[Dict[str, Any]] = Field(default=None, description="User-specified DAG params.  *New in version 2.0.1* ")
    end_date: Optional[datetime] = Field(default=None, description="The DAG's end date.  *New in version 2.3.0*. ")
    is_paused_upon_creation: Optional[StrictBool] = Field(default=None, description="Whether the DAG is paused upon creation.  *New in version 2.3.0* ")
    last_parsed: Optional[datetime] = Field(default=None, description="The last time the DAG was parsed.  *New in version 2.3.0* ")
    template_search_path: Optional[List[StrictStr]] = Field(default=None, description="The template search path.  *New in version 2.3.0* ")
    render_template_as_native_obj: Optional[StrictBool] = Field(default=None, description="Whether to render templates as native Python objects.  *New in version 2.3.0* ")
    __properties: ClassVar[List[str]] = ["dag_id", "dag_display_name", "root_dag_id", "is_paused", "is_active", "is_subdag", "last_parsed_time", "last_pickled", "last_expired", "scheduler_lock", "pickle_id", "default_view", "fileloc", "file_token", "owners", "description", "schedule_interval", "timetable_description", "tags", "max_active_tasks", "max_active_runs", "has_task_concurrency_limits", "has_import_errors", "next_dagrun", "next_dagrun_data_interval_start", "next_dagrun_data_interval_end", "next_dagrun_create_after", "max_consecutive_failed_dag_runs", "timezone", "catchup", "orientation", "concurrency", "start_date", "dag_run_timeout", "dataset_expression", "doc_md", "params", "end_date", "is_paused_upon_creation", "last_parsed", "template_search_path", "render_template_as_native_obj"]
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * OpenAPI `readOnly` fields are excluded.
        ...
        if self.tags:
            ...
            _dict['tags'] = _items
        # override the default output from pydantic by calling `to_dict()` of dag_run_timeout
        if self.dag_run_timeout:
            _dict['dag_run_timeout'] = self.dag_run_timeout.to_dict()
        ...
        # set to None if max_consecutive_failed_dag_runs (nullable) is None
        # and model_fields_set contains the field
        if self.max_consecutive_failed_dag_runs is None and "max_consecutive_failed_dag_runs" in self.model_fields_set:
            _dict['max_consecutive_failed_dag_runs'] = None

        # set to None if catchup (nullable) is None
        # and model_fields_set contains the field
        if self.catchup is None and "catchup" in self.model_fields_set:
            _dict['catchup'] = None
        ...
        # set to None if dataset_expression (nullable) is None
        # and model_fields_set contains the field
        if self.dataset_expression is None and "dataset_expression" in self.model_fields_set:
            _dict['dataset_expression'] = None
        ...
        # set to None if render_template_as_native_obj (nullable) is None
        # and model_fields_set contains the field
        if self.render_template_as_native_obj is None and "render_template_as_native_obj" in self.model_fields_set:
            _dict['render_template_as_native_obj'] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "dag_run_timeout": TimeDelta.from_dict(obj["dag_run_timeout"]) if obj.get("dag_run_timeout") is not None else None,
            "dataset_expression": obj.get("dataset_expression"),
