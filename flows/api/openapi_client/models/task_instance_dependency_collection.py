...
class TaskInstanceDependencyCollection(BaseModel):
    """
    TaskInstanceDependencyCollection
    """ # noqa: E501
    dependencies: Optional[List[TaskFailedDependency]] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "dependencies": [TaskFailedDependency.from_dict(_item) for _item in obj["dependencies"]] if obj.get("dependencies") is not None else None
        })
        return _obj
