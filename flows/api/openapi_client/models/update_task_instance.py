...
class UpdateTaskInstance(BaseModel):
    ...
    UpdateTaskInstance
    """ # noqa: E501
    dry_run: Optional[StrictBool] = Field(default=True, description="If set, don't actually run this operation. The response will contain the task instance planned to be affected, but won't be modified in any way. ")
    new_state: Optional[UpdateTaskState] = None
