...
class QueuedEventCollection(BaseModel):
    """
    ...
    datasets: Optional[List[QueuedEvent]] = None
    __properties: ClassVar[List[str]] = ["total_entries", "datasets"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "datasets": [QueuedEvent.from_dict(_item) for _item in obj["datasets"]] if obj.get("datasets") is not None else None
        })
        return _obj
