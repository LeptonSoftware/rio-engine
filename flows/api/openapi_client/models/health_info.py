...
class HealthInfo(BaseModel):
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "triggerer": TriggererStatus.from_dict(obj["triggerer"]) if obj.get("triggerer") is not None else None,
            "dag_processor": DagProcessorStatus.from_dict(obj["dag_processor"]) if obj.get("dag_processor") is not None else None
        })
        return _obj
