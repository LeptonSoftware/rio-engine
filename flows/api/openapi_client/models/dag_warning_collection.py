...
class DagWarningCollection(BaseModel):
    ...
    dag_warnings: Optional[List[DagWarning]] = None
    __properties: ClassVar[List[str]] = ["total_entries", "dag_warnings"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "dag_warnings": [DagWarning.from_dict(_item) for _item in obj["dag_warnings"]] if obj.get("dag_warnings") is not None else None
        })
        return _obj
